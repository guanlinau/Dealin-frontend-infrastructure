...
variable "cf_viewer_protocol_policy" {
  ...
  validation {
    ...
    error_message = "The variable value must be 'allow-all', 'https-only', 'redirect-to-https'."
  }
}
...
variable "cf_price_class" {
  ...
  validation {
    ...
    error_message = "The variable value must be 'PriceClass_All', 'PriceClass_200', 'PriceClass_100'."
  }
}
...
variable "cf_restriction_type" {
  ...
  validation {
    ...
    error_message = "The variable value must be 'none', 'whitelist', 'blacklist'."
  }
}
